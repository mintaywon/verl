...
def generate_rl_dataset(target_hdfs_path_dir, local_dir="~/data/helpfulness_hh_rlhf/rl"):
    dataset = load_dataset("Taywon/HH_full_parsed")
    train_dataset = dataset["train"]

    data_source = "Taywon/HH_full_parsed"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", type=str, default="~/data/helpfulness_hh_rlhf")
