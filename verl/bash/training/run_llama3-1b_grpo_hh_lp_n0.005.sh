...
$HOME/miniconda3/envs/verl/bin/python3 -m verl.trainer.main_ppo \
    ...
    +reward_model.length_penalty_factor=0.005 \
    algorithm.use_kl_in_reward=False \
    trainer.critic_warmup=0 \
    trainer.logger=['console','wandb'] \
    trainer.project_name='grpo_reward_hacking' \
    trainer.experiment_name='llama3_1b_grpo_lp_n0.005' \
    trainer.default_local_dir=$HOME/rhbench/verl/logs/llama-3.2-1b_grpo_lp_n0.005 \
